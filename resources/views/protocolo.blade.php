...
{{--                    <button type="button" class="btn btn-primary">Sim</button>--}}
    ...
    <h3>Olá Usuário!</h3>
    <p>Seja bem vindo ao Protocolo on-line da Secretaria de Estado de Esporte e Lazer do Distrito Federal</p>
    <p>No menu ao lado você possui todas as opções para lhe ajudar nas suas solicitações.</p>
    <hr>
    <h4>Protocolos anteriores</h4>
